...
namespace BilgeShop.Business.Managers
{
    public class UserManager : IUserService
    {
        ...
        public ServiceMessage AddUser(AddUserDto addUserDto)
        {
            ...
            // Eklenilmek istenen mail adresi ile veritabanında zaten bulunan verilerin tamamını çekiyorum. (Null gelirse, eklenebilir - null değilse zaten o kullanıcı adı mevcut.)
        ...
        public UserInfoDto LoginUser(LoginDto loginDto)
        {
            ...
            {
                return null;
                // Eğer form üzerinde gönderilen email adresi ile eşleşen bir veri tabloda yoksa, oturum açılamayacağı için geriye veri dönülmüyor.
            }
